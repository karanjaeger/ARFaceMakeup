...
// MakeUpChanger
struct MakeUpChanger_t53FB7ECA95FA2638B89B93B2BC28EE6FF43434A2;
...
IL2CPP_EXTERN_C String_t* _stringLiteral5E1982BB940113194DADA7B8E3CBD5223E40FF6C;
...
// MakeUpChanger
struct MakeUpChanger_t53FB7ECA95FA2638B89B93B2BC28EE6FF43434A2  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
	// UnityEngine.Material MakeUpChanger::makeUpMat
	Material_t18053F08F347D0DCA5E1140EC7EC4533DD8A14E3* ___makeUpMat_4;
	// UnityEngine.Texture2D[] MakeUpChanger::textures
	Texture2DU5BU5D_t05332F1E3F7D4493E304C702201F9BE4F9236191* ___textures_5;
};
...
#pragma clang diagnostic ignored "-Wunused-variable"
#endif
// System.Void MakeUpChanger::Start()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MakeUpChanger_Start_mF5618A7A3BAEA86E72C07BCFC0F6C1AD7DD66232 (MakeUpChanger_t53FB7ECA95FA2638B89B93B2BC28EE6FF43434A2* __this, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteral5E1982BB940113194DADA7B8E3CBD5223E40FF6C);
		s_Il2CppMethodInitialized = true;
	}
	{
		// makeUpMat.SetTexture("_Main_Tex", textures[0]);
		Material_t18053F08F347D0DCA5E1140EC7EC4533DD8A14E3* L_0 = __this->___makeUpMat_4;
		Texture2DU5BU5D_t05332F1E3F7D4493E304C702201F9BE4F9236191* L_1 = __this->___textures_5;
		NullCheck(L_1);
		int32_t L_2 = 0;
		Texture2D_tE6505BC111DD8A424A9DBE8E05D7D09E11FFFCF4* L_3 = (L_1)->GetAt(static_cast<il2cpp_array_size_t>(L_2));
		NullCheck(L_0);
		Material_SetTexture_m06083C3F52EF02FFB1177901D9907314F280F9A5(L_0, _stringLiteral5E1982BB940113194DADA7B8E3CBD5223E40FF6C, L_3, NULL);
		// }
		return;
	}
}
// System.Void MakeUpChanger::ChangeMakeUp(System.Int32)
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MakeUpChanger_ChangeMakeUp_m08C8FFC5EAC32885A82BEF3713682333BC547FC7 (MakeUpChanger_t53FB7ECA95FA2638B89B93B2BC28EE6FF43434A2* __this, int32_t ___0_textureIndex, const RuntimeMethod* method) 
{
	{
		// makeUpMat.mainTexture = textures[textureIndex];
		Material_t18053F08F347D0DCA5E1140EC7EC4533DD8A14E3* L_0 = __this->___makeUpMat_4;
		Texture2DU5BU5D_t05332F1E3F7D4493E304C702201F9BE4F9236191* L_1 = __this->___textures_5;
		int32_t L_2 = ___0_textureIndex;
		NullCheck(L_1);
		int32_t L_3 = L_2;
		Texture2D_tE6505BC111DD8A424A9DBE8E05D7D09E11FFFCF4* L_4 = (L_1)->GetAt(static_cast<il2cpp_array_size_t>(L_3));
		NullCheck(L_0);
		Material_set_mainTexture_m389E048BA9C81B603EBF36BD792212B296317AC0(L_0, L_4, NULL);
		// }
		return;
	}
}
// System.Void MakeUpChanger::.ctor()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MakeUpChanger__ctor_mD7A4CC367945654BDED5404559C5B2EF14353712 (MakeUpChanger_t53FB7ECA95FA2638B89B93B2BC28EE6FF43434A2* __this, const RuntimeMethod* method) 
{
	{
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
